      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12 gap-6">
        ...
        <div className="flex -space-x-4">
          {teamMembers.map(member => (
            <div key={member.id} className="w-12 h-12 rounded-full border-2 border-fabrick-black overflow-hidden relative group">
          ...
          <div className="space-y-4">
            {constructionProgress.map((item, i) => (
              <motion.div 
                ...
                className="glass-panel p-6 border-l-4 border-white/10 hover:border-fabrick-lava transition-all"
              >
                <div className="flex justify-between items-start mb-4">
                  <div className="flex items-center gap-4">
                    <div className={`p-3 bg-white/5 rounded-sm ${item.color}`}>
                      <item.icon size={24} />
                    </div>
                    <div>
          ...
          <div className="space-y-4">
            {resolvedIssues.map((issue, i) => (
              <motion.div 
                ...
                className="p-5 bg-white/5 border border-white/10 rounded-sm relative overflow-hidden"
              >
            ...
            <div className="p-6 border border-dashed border-white/10 rounded-sm flex flex-col items-center justify-center text-center">
