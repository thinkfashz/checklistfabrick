              ...
              >
                <div className="flex items-center gap-8 pb-8 border-b border-white/5">
                  <div className="relative group">
                    <div className="w-32 h-32 rounded-2xl bg-fabrick-yellow flex items-center justify-center text-fabrick-black text-4xl font-black shadow-yellow-glow overflow-hidden">
                      {profile.name.charAt(0)}
                    </div>
                    <button className="absolute -bottom-2 -right-2 p-3 bg-white text-fabrick-black rounded-xl shadow-xl opacity-0 group-hover:opacity-100 transition-opacity">
                      <Camera size={20} />
                    </button>
                  </div>
                  <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <input 
                        ...
                        className="w-full bg-white/5 border border-white/10 rounded-xl py-4 pl-12 pr-4 text-sm font-bold focus:border-fabrick-yellow outline-none transition-colors"
                      />
                    </div>
                  </div>
                  <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea 
                      ...
                      rows={1}
                      className="w-full bg-white/5 border border-white/10 rounded-xl py-4 px-4 text-sm font-bold focus:border-fabrick-yellow outline-none transition-colors resize-none"
                    />
                  </div>
                </div>
              </motion.div>
